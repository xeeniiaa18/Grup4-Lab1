...
Aquesta és la plantilla base per a la Pràctica 1 de l'assignatura d'EPAW. Està configurada perquè puguis començar a programar el teu backend en Java immediatament.
